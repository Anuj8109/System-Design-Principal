...
public class Facebook implements SocialNetwork{
    ...
    @Override
    public ProfileIterator createFriendsIterator(String profileEmial) {
        return new FacbookIterator(this, "friends", profileEmial);
    }

    @Override
    public ProfileIterator createCoworkersIterator(String profileEmail) {
        return new FacbookIterator(this, "coworkers", profileEmail);
    }
